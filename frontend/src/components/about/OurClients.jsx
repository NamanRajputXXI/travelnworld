    ...
    <section className="py-10 px-5 md:py-20 w-full">
      <div className="max-w-7xl mx-auto ">
        <div className="mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">What Our Happy Users Say!</h2>
        </div>
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="group bg-white border border-gray-300 rounded-xl p-6 transition-all duration-500 hover:border-orange-500 ">
              ...
              <div className="flex items-center gap-8 border-t border-gray-200 pt-5">
                <img className="rounded-full h-10 w-10" src={testimonial.img} alt="avatar" />
                <div>
